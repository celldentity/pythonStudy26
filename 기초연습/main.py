import time
### 전역변수 ###
#대부분 프로그래밍에서 1번이 되는(start)파일을 main 으로 만듦
...
names = []
emails = []
admins = []   #여기에 시스템담당자, 교수, 행정, 핵상, 손님 등등 별도로 권한 부여, 행정은 등록금 납부확인 관리 할 수 있어야 한다.
sns = []
login_user = None
kors = [] # 국어점수
engs = [] # 영어점수
